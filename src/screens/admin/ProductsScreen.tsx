...
const s = StyleSheet.create({
  ...
  // Detail
  detail: { width: 380, backgroundColor: COLORS.background },
  ...
  dTitle: { fontSize: 15, fontWeight: '700', color: COLORS.text },
  ...
  fLabel: { fontSize: 11, fontWeight: '600', color: COLORS.textSecondary, marginBottom: 4 },
  fInput: { backgroundColor: COLORS.card, borderWidth: 1, borderColor: COLORS.border, borderRadius: 6, paddingHorizontal: 10, paddingVertical: 8, fontSize: 13, color: COLORS.text },
  saveBtn: { backgroundColor: COLORS.primary, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 6 },
  saveBtnT: { color: COLORS.background, fontWeight: '700', fontSize: 13 },
});
